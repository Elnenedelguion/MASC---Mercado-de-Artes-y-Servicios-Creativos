...
from .views import (
    ...
    UsuarioViewSet, PagoViewSet, CategoriaViewSet,
    SubcategoriaViewSet, ProductoViewSet, CarritoProductoViewSet,
    HistorialCarritoViewSet, FacturacionViewSet, index, dashboard, login_view, register_view, logout_view
)
...
urlpatterns = [
    path('api/', include(router.urls)),  # Incluir las URLs del router
