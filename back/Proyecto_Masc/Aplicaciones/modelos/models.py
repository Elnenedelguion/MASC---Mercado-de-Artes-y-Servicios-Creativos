...
class Usuario(models.Model):
    ...
    email_usuario = models.EmailField(max_length=25)
...
class Carrito(models.Model):
    ...
    def __str__(self):
        return f"Carrito de {self.usuario.nombre_usuario} - {self.fecha_carrito}"
...
class CarritoProducto(models.Model):
    ...
    def __str__(self):
        return f"{self.cantidad_carrito_producto} de {self.producto.nombre_producto}"
...
class HistorialCarrito(models.Model):
    ...
    def __str__(self):
        return f"Historial de {self.carrito.usuario.nombre_usuario} - {self.fecha_historial_carrito}"
